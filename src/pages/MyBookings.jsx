export default function MyBookings() { return <div>My Bookings (coming soon)</div>; }
    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="table">
          ...
          <tbody>
            {items.map((b) => {
              const svc = b.serviceId || {}; // populated
            ...
            {items.length === 0 && (
              <tr><td colSpan="5" className="text-center text-sm">No bookings yet.</td></tr>
            )}
          </tbody>
        </table>
      </div>
